# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_atmos.ipynb.

# %% auto 0
__all__ = ['Model6SV', 'remap', 'SpectralLibrary', 'SpectralMatcher', 'ELC', 'DataCubeViewer']

# %% ../nbs/03_atmos.ipynb 5
...
# %% ../nbs/03_atmos.ipynb 6
from .data import *

# %% ../nbs/03_atmos.ipynb 8
