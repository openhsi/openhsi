# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/03_atmos.ipynb.

# %% auto 0
__all__ = ['Model6SV', 'remap', 'SpectralLibrary', 'SpectralMatcher', 'ELC', 'DataCubeViewer']

# %% ../nbs/api/03_atmos.ipynb 5
...
# %% ../nbs/api/03_atmos.ipynb 6
from .data import *

# %% ../nbs/api/03_atmos.ipynb 8
