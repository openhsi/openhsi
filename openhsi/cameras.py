...
__all__ = ['WebCamera', 'XimeaCameraBase', 'XimeaCamera', 'LucidCameraBase', 'LucidCamera', 'FlirCameraBase',
           'FlirCamera', 'switched_camera', 'SharedXimeaCamera', 'SharedFlirCamera', 'SharedLucidCamera']
