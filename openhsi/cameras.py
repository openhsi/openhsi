...
# %% auto 0
__all__ = ['WebCamera', 'switched_camera', 'FlirCameraBase', 'FlirCamera', 'SharedFlirCamera', 'HikrobotCameraBase', 'HikrobotCamera', 'SharedHikrobotCamera', 'LucidCameraBase', 'LucidCamera', 'SharedLucidCamera', 'SimulatedCameraBase', 'SimulatedCamera', 'SharedSimulatedCamera', 'XimeaCameraBase', 'XimeaCamera', 'SharedXimeaCamera']
...
# %% ../nbs/api/cameras/hikrobot.ipynb 8
@delegates()
