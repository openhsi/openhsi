# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/02_cameras.ipynb.

# %% auto 0
__all__ = ['WebCamera', 'XimeaCameraBase', 'XimeaCamera', 'LucidCameraBase', 'LucidCamera', 'FlirCameraBase', 'FlirCamera',
           'switched_camera', 'SharedXimeaCamera', 'SharedFlirCamera', 'SharedLucidCamera']

# %% ../nbs/api/02_cameras.ipynb 5
...
# %% ../nbs/api/02_cameras.ipynb 6
from .capture import OpenHSI

# %% ../nbs/api/02_cameras.ipynb 8
@delegates()
