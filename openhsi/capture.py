...
# %% ../nbs/01_capture.ipynb 6
from .data import DataCube, CircArrayBuffer

# %% ../nbs/01_capture.ipynb 7
@delegates()
...
# %% ../nbs/01_capture.ipynb 38
from .shared import SharedOpenHSI

# %% ../nbs/01_capture.ipynb 39
@delegates()
