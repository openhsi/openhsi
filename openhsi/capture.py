...
# %% auto 0
__all__ = ['OpenHSI', 'SimulatedCamera', 'ProcessRawDatacube', 'ProcessDatacube']
...
class ProcessDatacube(ProcessRawDatacube):
    ...
    def __init__(self, fname:str, processing_lvl:int, json_path:str, pkl_path:str, old_style:bool=False,**kwargs):
        ...
        super().__init__(fname, processing_lvl, json_path, pkl_path, old_style=False,**kwargs)
