# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/06_metadata.ipynb.
...
# %% ../nbs/api/06_metadata.ipynb 6
import panel as pn
import panel.widgets as pnw
pn.extension()
from datetime import datetime

# %% ../nbs/api/06_metadata.ipynb 8
