# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/00_data.ipynb.

# %% auto 0
__all__ = ['Shape', 'DType', 'Array', 'CircArrayBuffer', 'CameraProperties', 'DateTimeBuffer', 'DataCube']

# %% ../nbs/api/00_data.ipynb 4
...
# %% ../nbs/api/00_data.ipynb 40
from functools import reduce
import psutil

# %% ../nbs/api/00_data.ipynb 41
@delegates()
